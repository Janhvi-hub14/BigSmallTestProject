...
namespace BigSmallTestProject.Utilities
{
    [Binding]
    public static class BaseClass
    {
        ...
        {
            var htmlReport = new ExtentHtmlReporter(@"C:\Users\mindtreejanedge234\source\repos\BigSmallTestProject\BigSmallTestProject\index.Html");
            ...
            Log.Logger = new LoggerConfiguration()
                         ...
                         .File(@"C:\Users\mindtreejanedge234\source\repos\BigSmallTestProject\BigSmallTestProject\Logs", outputTemplate: "{TimeSpamp:yyyy-MM-dd HH:mm:ss.fff} | {Level:u3} | {Message} {NewLine}", rollingInterval: RollingInterval.Day)
                         .CreateLogger();
